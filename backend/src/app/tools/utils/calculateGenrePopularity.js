 ...
 */
export const calculateGenrePopularity = (genres, baseValue) => {
    const genreCounts = {};
    ...
    const sortedGenres = Object.entries(genreCounts).sort(([_, countA], [__, countB]) => countB - countA);
    ...
    logger.info(`Calculated genre popularity using Pareto distribution: ${JSON.stringify(genrePopularity)}`);
